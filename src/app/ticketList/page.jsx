...
export default function TicketList() {
  ...
  return (
    <div className="bg-white">
      ...
      {selectedTicket && <Ticket ticket={selectedTicket} open={selectedTicket !== null} setOpen={setSelectedTicket} />}
    </div>
  );
}
